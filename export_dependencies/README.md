...
Progress is printed on a single updating line (overwritten in place). With `--debug`, additional diagnostic lines may appear. For example:
```
...
(1/9876) processing dependency: pypi://urllib3@1.26.20            # single-line progress
...
```
