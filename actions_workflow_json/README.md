## Get projects with their github action workflows (packages) and their actions (dependencies). 
This script will produce a json of all projects with their workflows packages and actions.
## SETUP
